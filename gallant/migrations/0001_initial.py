    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=2, choices=[(b'0', b'Individual'), (b'1', b'Organization')])),
                ('size', models.CharField(max_length=2, choices=[(b'3', b'Large'), (b'2', b'Medium'), (b'0', b'Micro'), (b'1', b'Small')])),
                ('status', models.CharField(max_length=2, choices=[(b'0', b'Approached'), (b'8', b'Blacklisted'), (b'2', b'Brief_Sent'), (b'7', b'Check_Notes'), (b'6', b'Past_Due'), (b'4', b'Pending_Deliverables'), (b'3', b'Pending_Payment'), (b'1', b'Quoted'), (b'5', b'Settled')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('text', models.TextField(help_text=b'User comment / note.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', gallant.fields.ULCharField()),
                ('description', gallant.fields.ULTextField(null=True)),
                ...
                ('cost', djmoney.models.fields.MoneyField(default=Decimal('0.0'), max_digits=10, decimal_places=2, default_currency=b'USD')),
                ('quantity', models.IntegerField()),
                ('type', models.CharField(max_length=2, choices=[(b'3', b'Advertising'), (b'2', b'Architecture'), (b'0', b'Branding'), (b'1', b'Design'), (b'7', b'Fashion_Design'), (b'5', b'Illustration'), (b'6', b'Industrial_Design'), (b'8', b'Interior_Design'), (b'4', b'Production')])),
                ('notes', models.ManyToManyField(to='gallant.Note')),
                ('parent', models.ForeignKey(related_name='sub_services', blank=True, to='gallant.Service', null=True)),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
