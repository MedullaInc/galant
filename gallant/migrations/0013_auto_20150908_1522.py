...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gallant', '0012_auto_20150903_1422'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='client',
            name='size',
            field=models.CharField(blank=True, max_length=2, choices=[(b'0', b'Micro'), (b'1', b'Small'), (b'2', b'Medium'), (b'3', b'Large')]),
        ),
        migrations.AlterField(
            model_name='client',
            name='status',
            field=models.CharField(blank=True, max_length=2, choices=[(b'0', b'Approached'), (b'1', b'Quoted'), (b'2', b'Brief_Sent'), (b'3', b'Pending_Payment'), (b'4', b'Pending_Deliverables'), (b'5', b'Settled'), (b'6', b'Past_Due'), (b'7', b'Check_Notes'), (b'8', b'Blacklisted')]),
        ),
        migrations.AlterField(
            model_name='client',
            name='type',
            field=models.CharField(blank=True, max_length=2, choices=[(b'0', b'Individual'), (b'1', b'Organization')]),
        ),
    ]
