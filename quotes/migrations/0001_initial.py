    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(related_name='versions', blank=True, to='quotes.Quote', null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='polymorphic_quotes.section_set+', editable=False, to='contenttypes.ContentType', null=True),
        ),
        migrations.AddField(
            model_name='section',
            name='user',
        ...
        migrations.AddField(
            model_name='quote',
            name='sections',
            field=models.ManyToManyField(related_name='sections', to='quotes.TextSection', blank=True),
        ),
        migrations.AddField(
            model_name='quote',
            name='services',
