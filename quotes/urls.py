...
urlpatterns = [
    ...
    url(r'^template/add/$', login_required(views.QuoteTemplateView.as_view()), name='add_quote_template'),
    url(r'^template/edit/(?P<pk>[0-9]+)$',
        login_required(views.QuoteTemplateView.as_view()), name='edit_quote_template'),
]