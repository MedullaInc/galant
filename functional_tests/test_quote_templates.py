...
class QuoteTemplatesTest(browser.SignedInTest):
    ...
    def test_edit_quote_template(self):
        ...
        intro = b.find_element_by_id('id_-section-0_intro_title')
    ...
    def _add_language_and_text(self, b):
        ...
        b.find_element_by_id('id_-section-0_intro_title').clear()
        b.find_element_by_id('id_-section-0_intro_title').send_keys('titulo de intro prueba')
        b.find_element_by_id('en_tab').click()

        new_tab = b.find_element_by_xpath('//*[@id="es_tab"]/a')
        self.assertEqual(u'Spanish', new_tab.text)

        intro = b.find_element_by_xpath('//input[@id="id_-section-0_intro_title"]')
