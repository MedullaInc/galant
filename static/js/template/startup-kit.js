...
startupKit.uiKitContent.content1 = function() {
    $('.content-1 .control-btn').on('click', function() {
...
startupKit.uiKitContent.content3 = function() {
    $(window).resize(function() { 
        var maxH = 0;
        $('.content-3 section').each(function() {
            var h = $(this).outerHeight();
            if (h > maxH)
                maxH = h;
        });
        $('.content-3 .page-transitions').css('height', maxH + 'px');
        var ctrlsHeight = $('.content-3 .pt-controls').height();
        $('.content-3 .pt-controls').css('margin-top', (-1) * ctrlsHeight / 2 + 'px');
    });
    // PageTransitions
    var pt = PageTransitions();
    pt.init('#content-3-pt-main'); 
    $('.content-3 .pt-controls .pt-indicators > *').on('click', function() {
        if ($(this).hasClass('active'))
            return false;
        var curPage = $(this).parent().children('.active').index();
        var nextPage = $(this).index();
...
startupKit.uiKitContent.content4 = function() {
    $(window).resize(function() {
        var maxH = 0;
        $('.content-4 section').each(function() {
            var h = $(this).outerHeight();
            if (h > maxH)
                maxH = h;
        });
        $('.content-4 .page-transitions').css('height', maxH + 'px');
        var ctrlsHeight = $('.content-3 .pt-controls').height();
        $('.content-4 .pt-controls').css('margin-top', (-1) * ctrlsHeight / 2 + 'px');
    });
    // PageTransitions
    var pt = PageTransitions();
    pt.init('#content-4-pt-main');
    $('.content-4 .pt-controls .pt-indicators > *').on('click', function() {
        if ($(this).hasClass('active'))
            return false;
        var curPage = $(this).parent().children('.active').index();
        var nextPage = $(this).index();
